...
storage_cols[1].metric("Workspace DB Files", storage["account_database_count"])
storage_cols[2].metric("Persistent Dir Set", "Yes" if storage["configured_data_dir"] else "No")
storage_cols[3].metric("Using App Folder", "Yes" if storage["local_app_storage"] else "No")
